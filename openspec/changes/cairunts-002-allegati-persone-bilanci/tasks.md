...
- [ ] 10.5 Rieseguire lo scraper su entrambi gli enti: nessun file riscaricato (cache_hit = totale allegati)
- [ ] 10.6 Aprire la scheda web di Pisa e Parma: verificare che le tre sezioni (allegati, bilanci, cariche) appaiano con dati coerenti
- [ ] 10.7 Scaricare i PDF di Pisa e Parma: verificare che contengano le tre sezioni aggiuntive con carta intestata su tutte le pagine
- [ ] 10.8 Verificare che un ente senza documenti non mostri titoli di sezione orfani nella scheda web né nel PDF
